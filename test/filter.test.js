...
describe("filter", () => {
    ...
    // testMaker.testCase("[{y: false}], function returns value of y. Return empty array.", [], [[{ y: false }], giveY]);
    // testMaker.testCase("[{y: null}], function returns value of y. Return empty array.", [], [[{ y: null }], giveY]);
    // testMaker.testCase("[{y: 0}], function returns value of y. Return empty array.", [], [[{ y: 0 }], giveY]);
    // testMaker.testCase("[{y: undefined}], function returns value of y. Return empty array.", [], [[{ y: undefined }], giveY]);
    // testMaker.testCase("[{y: \"\"}], function returns value of y. Return empty array.", [], [[{ y: "" }], giveY]);
    // testMaker.testCase("[{y: NaN}], function returns value of y. Return empty array.", [], [[{ y: NaN }], giveY]);
    ...
    // testMaker.testCase("Array of objects with no property y, function returns value of y. Return empty array", [], [truthyX, giveY]);
