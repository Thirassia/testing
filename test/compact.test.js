...
describe("compact", () => {
    ...
    // testMaker.testCase("Return a list with undefined-value removed",
    // [{ ":)": 2 }], [[undefined, { ":)": 2 }]]);
    // testMaker.testCase("Return a list with NaN-value removed",
    // [4, 3, 9], [[4, 3, 9, NaN]]);
    // testMaker.testCase("Return a list with multiple falsey values removed",
    // [4, 12], [[false, undefined, 4, "", 12]]);
    // testMaker.testCase("Return an unaltered list with no falsey values",
    // [3, "ss", 1], [[3, "ss", 1]]);
    testMaker.testCase(
        "Return an empty list with all values removed because they were falsey",
        [],
        [["", false]],
    );
    testMaker.testCase(
        "Return an unaltered empty list",
        [],
        [[]],
    );
});
